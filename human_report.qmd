...
Grâce au test du chi carré, nous avons pu remarqué que la masse augmente en fonction de l'âge. Ceci est assez logique est et en accord avec la littérature scientifique. Cependant, avec le test t de Student nous n'observons pas de différence significative d'ICM entre les deux genres. Il est très important de noter que, en vue de la faible taille de notre échantillon et de l'échantillonnage non aléatoire, cette information n'est pas fiable. Avec un autre test de t student, nous n' avons pas su montré que le tabac impacte de manière significative l'IMC. Finalement un test anova ne nous indique aucune différences significative entre l'IMC et le nombre d'heures d'activité physique. Il n'y aurait donc pasde lien entre l'activitée physique et l'obésité. Ce résultat va bien évidemment à l'encontre de nombreuses études scientifiques.
