...
Tout d'abord il est important de noter que l'échantillon n'est pas représentatif car l'échantilonage n'est pas aléatoire et les différentes observations ne sont pas indépendantes entre elles. Il a donc fallu être prudent lors de l'analyse des résultats. Nous aimerions aussi rapeler ici la notion de cause a effet : Une personne qui fume, bois beaucoup d'alcool , ne fais pas de sport et mange quotidienment des fast-foods est en sur-poids. Chaque un des facteurs ci-dessus est en corélation avec l'obésité mais chaque un des facteurs n'est pas forcément la cause de l'obésité.
