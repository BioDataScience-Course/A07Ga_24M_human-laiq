...
Tout d'abord il est important de noter que l'échantillon n'est pas représentatif car échantillonnage n'est pas aléatoire et les différentes observations ne sont pas indépendantes entre elles. Il a donc fallu être prudent lors de l'analyse des résultats. Nous aimerions aussi rapeller ici la notion de cause a effet : Une personne qui fume, bois beaucoup d'alcool , ne fais pas de sport et mange quotidiennement des fast-foods est en sur-poids. Chaque un des facteurs ci-dessus est en corrélation avec l'obésité mais chaque un des facteurs n'est pas forcément la cause de l'obésité.

Dans notre jeu de données nous avons pu constater quelques différences notables. entre les hommes et les femmes. En effet, les hommes font plus de sport mais consomment plus d'alcool et de fast-food que les femmes qui elles, fument plus que les hommes. Ce résultat est bien sur à prendre avec des pincettes car il est propre à notre échantillon et qu'il peut y avoir la présence d'une valeur abérante qui va fausser les résultats.

Grâce au test du chi carré, nous avons pu remarqué que la masse augmente en fonction de l'âge. Ceci est assez logique est et en accord avec la littérature scientifique. Cependant, le test t de student nous a permis nous a montré que dans notre échantillon nous n'observons pas de différence de manière significative entre les deux genres sur l'IMC. Il est très important de noter que, en vue de la faible taille de notre échantillon et que celui-ci n'est pas représentatif, cette information est à prendre avec de gros guillemets. Avec un autre teste t de student, nous n' avons pas su montré que le tabac n'a pas d'impact de manière significative sur l'IMC. Finalement un test anova nous montre aucune différences de manière significative entre l'IMC et le nombre d'heures d'activitée physique et donc l'absence de lien entre l'activitée physique et l'obésité. Ce résultat va bien évidemment à l'encontre de nombreuses études scientifiques. Il peut être expliquer par un échantillon non représentatif ou par la présence d'autres facteurs d'obésité : si une personne mange un fast-food tout les jours et que cette mme personne fait du sport régulièrement, alors il n'y aura pas de liens direct entre le sport et l'IMC.

En conclusion, il y a un rapport de manière significatif sur l'IMC en fonction de l'âge, ce résultat était attendu et est en raccord avec celui de Thérésa Lebacq. En revanche, on n'a pas pu montrer l'impact du genre , du tabac , du sucre , et de l'activité physique sur l'obésité. Ces résultats en revanche ne sont pas du tout ceux attendus et sont probablement liés à des problèmes d'échantillonnage , en effet, nous l'avons signaler, notre échantillon n'est absolument pas représentatif.
