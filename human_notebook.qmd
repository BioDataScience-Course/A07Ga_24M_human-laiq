...
source : https://institut-sommeil-vigilance.org/wp-content/uploads/2018/12/Actu-Carnet-Sommeil-Nutrition.pdf
https://pubmed.ncbi.nlm.nih.gov/19444258/
...
source : https://www.topsante.com/nutrition-et-recettes/les-bons-aliments/eau/un-urologue-a-tranche-voici-la-quantite-parfaite-de-liquide-a-boire-par-jour-657251
...
-   Test de chi carré d'indépendance, lien entre l'âge et l'IMC
Nous observons que la masse augmente en fonction de l'âge. Ceci est cohérent et en accord avec la littérature scientifique.

-   Test t Student, comparaison de l'IMC entre les hommes et les femmes
Nous n'observons pas de différence significative d'ICM entre les deux genres. Il est très important de noter que, compte tenu la faible taille de notre échantillon et de l'échantillonnage non aléatoire, cette analyse ne peut pas être considéré comme fiable.

-   Test t pour les moyennes indépendantes, effet du tabagisme sur la répartition de la graisse abdominale
Nous n'avons pas pu démontré que le tabac impacte de manière significative l'IMC. En effet, la nicotine à la fois supprime et stimule l'appétit.

-   ANOVA à un facteur, lien entre activité physique et IMC
Ce test ne révèle aucune différence significative entre l'IMC et le nombre d'heures d'activité physique. Il n'y aurait donc pas de lien entre l'activité physique et l'obésité. Ce résultat contredit de nombreuses études scientifiques.
