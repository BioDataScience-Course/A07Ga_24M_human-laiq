...
H0 : moyenne rapport tour taille et taille des fumeurs- moyenne rapport tour taille et taille des non fumeurs= 0

H1 : moyenne rapport tour taille et taille des fumeurs - moyenne rapport tour taille et taille des non fumeurs!= 0
...
Ces résultats sont en accords avec
...
```{r plot_anova2_1}
chart(data=biometry, imc ~ fast_food | genre) + geom_point()
```
