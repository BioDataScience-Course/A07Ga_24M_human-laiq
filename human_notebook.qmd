...
ET RATIO TOUR DE TAILLE/TAILLE), qui indiquait : " l\'IMC moyen augmente, par ailleurs, en fonction de l\'âge".
...
H0 : moyenne(bmiH) - moyenne(bmiF) = 0

H1 : moyenne(bmiH) - moyenne(bmiF) \> 0
...
ET RATIO TOUR DE TAILLE/TAILLE), qui indiquait : "Les hommes possèdent un IMC
moyen supérieur aux femmes".
