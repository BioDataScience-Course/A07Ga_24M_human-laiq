...
On ne rejette pas H0 au seuil alpha de 5% . Donc on ne peut pas montrer de manière significative qu'il y ait un rapport entre les moyennes des rapports tour de taille/taille des fumeurs et non fumeurs. Nos résultats sont en désaccord avec l'article de la revue ELSEVIER "The effects of smoking a-on obesity : Evidences of a randomized trial". (L'article est basé sur la Lung Health Study).
